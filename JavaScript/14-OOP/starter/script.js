...
// 3) Public methods
// 4) Private methods
// Also same for static fields/methods

class Account {
  // 1) Public fields(created on all instance instead of prototype)
  locale = navigator.language;

  // 2) Private fields(created on all instance instead of prototype)
  #movements = [];
  #pin;
